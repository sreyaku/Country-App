...
function RegisterPageForm() {
    ...
    const validate = () => {
        ...
        else if (JSON.parse(localStorage.getItem('registerUser') != null)) {
    ...
    const registerFormHandler = (event) => {
        ...
        if (isValid) {
            if (localStorage.getItem('count') != null) {
                ...
                registerUser[count] = inputDetails
                count = count + 1
                JSON.parse(localStorage.setItem('count', JSON.stringify(count)))
                localStorage.setItem('registerUser', JSON.stringify(registerUser))
                console.log(registerUser)
                console.log(count)
            }
    ...
    useEffect(() => {
        ...
        if (JSON.parse(localStorage.getItem('registerUser')) != null && localStorage.getItem('count')) {
